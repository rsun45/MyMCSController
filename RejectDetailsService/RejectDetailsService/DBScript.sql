...
CREATE DATABASE [MCS]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'mcs', FILENAME = N'D:\Developing\MS SQL Server 2019 Express\MSSQL15.SQLEXPRESS\MSSQL\DATA\mcs.mdf' , SIZE = 270336KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'mcs_log', FILENAME = N'D:\Developing\MS SQL Server 2019 Express\MSSQL15.SQLEXPRESS\MSSQL\DATA\mcs_log.ldf' , SIZE = 794624KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
